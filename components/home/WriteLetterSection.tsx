    ...
    <section className="w-full py-16">
      <div className="container mx-auto px-4 sm:px-8 lg:px-20">
        ...
        <div className="relative max-w-[920px] mx-auto">
          {/* 하이라이트 박스 */}
          <div className="absolute -top-5 sm:-top-7 left-1/2 -translate-x-1/2 w-[160px] sm:w-[240px] h-10 sm:h-14 bg-[#FF7F65] opacity-60 rounded" />

          {/* 메인 카드 */}
          <div className="relative bg-[#FEFEFE] border border-[#C4C4C4] rounded-xl p-6 sm:p-12 shadow-[12px_12px_40px_rgba(0,0,0,0.12)] overflow-hidden min-h-[280px] sm:min-h-0">
            {/* 구멍들 - 모바일에서 숨김 */}
            ...
            {/* To. 라벨 - 하이라이트 */}
            <div className="absolute top-[40px] sm:top-[64px] left-[24px] sm:left-[72px]">
            ...
            {/* 받는 사람 */}
            <div className="absolute top-[40px] sm:top-[64px] left-[80px] sm:left-[138px]">
              <span className="text-base sm:text-2xl font-semibold text-[#424242]">보내고 싶은 누군가</span>
            </div>

            {/* 날짜 */}
            <div className="absolute top-[44px] sm:top-[68px] right-6 sm:right-12">
              <span className="text-sm sm:text-lg text-[#424242]">20xx.xx.xx</span>
            </div>

            {/* 내용 */}
            <div className="absolute top-[100px] sm:top-[160px] left-[24px] sm:left-[72px]">
            ...
            {/* 서명 */}
            <div className="absolute bottom-[40px] sm:bottom-[68px] right-6 sm:right-12 flex items-center gap-2 sm:gap-3">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4 sm:gap-8 mt-8 sm:mt-16">
          <Link href="/write?type=story" className="px-6 py-3 sm:py-4 bg-[#FF7F65] text-[#F9F9F9] text-lg sm:text-2xl font-semibold rounded hover:bg-[#FF6B50] transition-colors text-center">
            사연 신청하기
          </Link>
          <Link href="/stories" className="px-6 py-3 sm:py-4 border-2 border-[#FF7F65] text-[#FF7F65] text-lg sm:text-2xl font-semibold rounded hover:bg-[#FFF5F3] transition-colors text-center">
            사연 보러가기
          </Link>
        </div>
      </div>
